...
<div class="home-bg">
   ...
   <section class="home">
      ...
      <div class="content">
         <span>pas de panique, passez à l'organice</span>
         <h3>Atteignez pour une meilleure santé avec des aliments biologiques</h3>
         <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto natus culpa officia quasi, accusantium explicabo?</p>
         <a href="about.php" class="btn">apropos de nous</a>
      </div>
...
<section class="home-category">
   ...
   <h1 class="title">Produit par catégorie</h1>
...
<section class="products">
   ...
   <form action="" class="box" method="POST">
      <div class="price">CFA <span><?= $fetch_products['price']; ?></span>/-</div>
